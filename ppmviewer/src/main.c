...
void afficherMenu() {
    ...
    printf("gris <entrée.ppm> <sortie.ppm>     Convertit l'image en niveaux de gris\n");
    printf("neg <entrée.ppm> <sortie.ppm>      Crée le négatif de l'image\n");
    printf("dom <R|G|B> <val> <fichier.ppm>    Modifie les pixels dominants et crée <fichier>_dom.ppm\n");
    printf("cut <entrée.ppm> <l1> <l2> <c1> <c2> <sortie.ppm>\n");
    printf("                                  Découpe une partie de l'image\n");
    printf("fil <entrée.ppm> <sortie.ppm>      Applique un filtre médian\n");
